...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      style={{
        backgroundColor: 'color-mix(in oklab, var(--background) 88%, white 12%)',
